...
export default function LectureView() {
  ...
  return (
    <section className="space-y-6">
      ...
      <Tabs
        value={activeTab}
        onChange={(val) => setActiveTab(val as LectureTabKind | 'flashcards' | 'quiz' | 'chat')}
        tabs={[
          { value: 'transcript', label: '📝 Transkrypcja' },
          { value: 'cleaned', label: '✨ Oczyszczona' },
          { value: 'detailed_note', label: '📋 Szczegółowa notatka' },
          { value: 'short_note', label: '📄 Krótka notatka' },
          { value: 'key_points', label: '🎯 Kluczowe punkty' },
          { value: 'question_bank', label: '❓ Bank pytań' },
          { value: 'flashcards', label: '🃏 Fiszki' },
          { value: 'quiz', label: '📝 Quiz' },
          { value: 'mindmap', label: '🗺️ Mapa myśli' },
